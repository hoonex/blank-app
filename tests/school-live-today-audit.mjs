...
await page.mouse.move(box.x+box.width/2,box.y+70);await page.mouse.down();await page.mouse.move(box.x+box.width/2,box.y-10,{steps:8});
...
await fs.writeFile(`${OUT}/report.json`,JSON.stringify({state,beforeDrag,duringDrag,after,errors},null,2));
