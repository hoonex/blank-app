...
function assertWideTodayDensity(c,s){
  ...
  if(!grid||!card||!feed||!heading)throw new Error(`${c.name}: Today density geometry missing ${JSON.stringify({todayGrid:s.todayGrid,upcoming:s.upcoming,upcomingHeading:s.upcomingHeading,examFeed:s.examFeed})}`);
