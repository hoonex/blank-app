...
const landscapeContext=await browser.newContext({viewport:{width:844,height:390},isMobile:true,hasTouch:true,locale:'ko-KR',timezoneId:'Asia/Seoul'});const landscape=await universityFixtures(landscape);