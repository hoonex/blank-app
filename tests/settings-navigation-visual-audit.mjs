...
for (const c of CASES) {
  ...
  try {
    ...
    await page.locator('#bottomNav > .mobile-tab[data-view="today"]:visible').click();
    await page.locator('#todayView:not(.hidden)').waitFor();
    await page.locator('.timetable-mode-button:visible').click();
    ...
    const navState = await page.evaluate(() => ({
      ...
      weekActive: document.querySelector('.timetable-mode-toggle .timetable-mode-button')?.classList.contains('active') || false,
