...
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-flow-exam-visible="0"]{height:76px}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-flow-exam-visible="1"]{height:126px}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-flow-exam-visible="2"]{height:190px}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-card{position:absolute;left:0;right:0;top:0;box-sizing:border-box;min-height:112px;padding:15px 16px;border:0;border-radius:18px;corner-shape:squircle;background:color-mix(in srgb,var(--surface) 96%,var(--surface-2));box-shadow:0 9px 24px rgba(43,57,78,.065),inset 0 1px 0 rgba(255,255,255,.75);transform-origin:50% 0;transition:transform .25s cubic-bezier(.18,.86,.2,1),opacity .22s ease,filter .22s ease;will-change:transform,opacity}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[style*="--flow-exam-drag"]:not([data-swipe]) .flow-exam-card{transition-duration:0s!important}
...
html[data-flow-school-ui="v2"] body #todayView .flow-exam-card[data-depth="1"]{z-index:2;transform:translate3d(8px,calc(94px + var(--flow-exam-drag,0px)),-20px) scale(.965);opacity:.86;filter:saturate(.92)}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-card[data-depth="2"]{z-index:1;transform:translate3d(15px,calc(154px + var(--flow-exam-drag,0px)),-42px) scale(.93);opacity:.72;filter:saturate(.9) blur(.08px)}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-swipe="up"] .flow-exam-card[data-depth="0"]{transform:translate3d(0,-88px,0) scale(.972);opacity:0}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-swipe="up"] .flow-exam-card[data-depth="1"]{transform:translate3d(0,0,0) scale(1);opacity:1;filter:saturate(1)}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-swipe="up"] .flow-exam-card[data-depth="2"]{transform:translate3d(8px,94px,-20px) scale(.965);opacity:.86;filter:saturate(.92)}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-swipe="down"] .flow-exam-card[data-depth="0"]{transform:translate3d(0,64px,0) scale(.985);opacity:0}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-swipe="down"] .flow-exam-card[data-depth="1"]{transform:translate3d(10px,110px,-24px) scale(.958);opacity:.8}
html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-swipe="down"] .flow-exam-card[data-depth="2"]{transform:translate3d(18px,172px,-48px) scale(.922);opacity:.62}
...
@media(max-width:900px){html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-flow-exam-visible="0"]{height:72px}html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-flow-exam-visible="1"]{height:122px}html[data-flow-school-ui="v2"] body #todayView .flow-exam-stack[data-flow-exam-visible="2"]{height:186px}}
