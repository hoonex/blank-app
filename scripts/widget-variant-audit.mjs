...
const validDayContent=semantic.day.rowsCount>=1||semantic.day.title==='오늘 일정 완료';
if(semantic.day.cols!=='2'||semantic.day.rows!=='1'||!semantic.day.listVisible||!validDayContent)throw new Error(`Day-flow wide variant failed: ${JSON.stringify(semantic)}`);
