...
window.addEventListener('resize',()=>{if(Math.abs(density-1)>=DENSITY_EPSILON)scheduleReapply(220);else markDefaultDensity(getGrid())},{passive:true});
