...
const UI_BUILD='20260827-2';
const STYLES=['/university/ui-unify.css','/university/ui-unify-v2.css','/university/campus-ui-polish.css','/university/page-header.css','/university/profile-composition.css','/university/settings-wide.css','/university/landscape-toolbar.css'].map(x=>`${x}?v=${UI_BUILD}`);
