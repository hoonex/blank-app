...
const STYLES=['/university/ui-unify.css','/university/ui-unify-v2.css','/university/campus-ui-polish.css','/university/page-header.css','/university/profile-composition.css'].map(x=>`${x}?v=${UI_BUILD}`);
